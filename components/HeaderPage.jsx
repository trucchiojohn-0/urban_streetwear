            ...
            <nav className="bg-white px-4 lg:px-5 py-5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="/" className="flex items-center">
                        ...
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-black">Urban</span>
                    </a>
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <a href="/upgrade" className="block py-2 pr-4 pl-3 text-black hover:text-gray-500 transition-colors duration-200 border-b border-gray-100 lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-black dark:hover:text-gray-400 underline underline-offset-2">
                                    GET PRO
                                </a>
                            </li>
                        </ul>
